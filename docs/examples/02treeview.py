'''
Using Treeview to compare the effects of changing the theme with a customised 
configure.

Since Treeview is a composite widget we require 2 configure clauses - one for 
the heading the other for the content of the contents. The first treeview is 
the theme standard, the second treeview is configured. 

The content of Text has been formatted to display the layout in a more pleasing
manner.
'''
...
la2 = Label(root,text='Notice how the lower Treeview changes with theme')
la2.pack(padx=5, pady=5)
