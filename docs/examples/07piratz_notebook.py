...
class NotebookDemo:
    ...
    def __init__(self, fr):
        ...
        self.fr = fr
        self.st1 = Style() # ts.ThemedStyle() # Style()
    ...
    def _create_descrip_tab(self, nb):
        ...
        themes = list(sorted(self.st1.theme_names())) # get_themes # used in ttkthemes
    ...
    def _create_treeview_tab(self, nb):
        ...
        self.st1.configure('fact.Treeview', rowheight=fact,
